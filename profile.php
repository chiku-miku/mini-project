<?php
    ...
    if(isset($_POST['first_name'])){
        ...
        $sql = "INSERT INTO users (first_name, middle_name, last_name, gender, date_of_birth, email_id, mobile_no, caste) 
        VALUES ('".$_POST['first_name']."', '".$_POST['middle_name']."', '".$_POST['last_name']."'),  '".$_POST['gender']."', '".$_POST['date_of_birth']."', '".$_POST['email_id']."', '".$_POST['mobile_no']."', '".$_POST['caste']."')";
